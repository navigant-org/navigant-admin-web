  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        ...
        storage.save(KEYS.AUTH_TOKEN, data.token);
                  ...
                  >
                    {showPassword ? (
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414l-1.414-1.414A9 9 0 0010 18c4.478 0 8.268-2.943 9.542-7-1.274-4.057-5.064-7-9.542-7-1.87 0-3.605.513-5.097 1.41L3.707 2.293zM6.9 8.314A3.99 3.99 0 009.686 11.1L6.9 8.314zM11.686 13.1l-2-2a4 4 0 01-1.371-1.372l-2-2a6 6 0 005.371 5.372z"
                          clipRule="evenodd"
                        />
                      </svg>
                    )}
